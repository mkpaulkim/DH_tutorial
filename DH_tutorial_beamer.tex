...
\begin{frame}{Denis Gabor}
	...
	\begin{figure}
		\includegraphics[width=2.0 in]{DH_tutorial_md.assets/image-20220426134139308}
	\end{figure}
...
\begin{frame}{E N Leigth \& J Upatnieks}
	...
	\begin{figure}
		\includegraphics[width=2.0 in]{DH_tutorial_md.assets/image-20220426135144501}
	\end{figure}
...
\begin{frame}{JW Goodman}
	...
	\begin{figure}
		\includegraphics[width=2.0 in]{DH_tutorial_md.assets/image-20220426135625638}
	\end{figure}
...
\begin{frame}{U Schnars \& W. Jueptner}
	...
	\begin{figure}
		\includegraphics[width=1.4 in]{DH_tutorial_md.assets/image-20220426140019172}
	\end{figure}
...
\begin{frame}{C Depeursinge}
	...
	\begin{figure}
		\includegraphics[width=2.0 in]{DH_tutorial_md.assets/image-20220426140050211}
	\end{figure}
